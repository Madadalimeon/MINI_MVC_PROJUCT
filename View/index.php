            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="images/<?php echo $row['Products_img']; ?>" alt="<?php echo $row['Products_name']; ?>" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="Shop.php?add_to_cart=<?php echo $row['Products_id']; ?>" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                    </div>
                  </div>
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="#"><?php echo $row['Products_name']; ?></a>
                    </h3>
                    <span class="item-price text-primary">$<?php echo $row['Products_price']; ?></span>
                  </div>
                </div>
              </div>
              <?php
